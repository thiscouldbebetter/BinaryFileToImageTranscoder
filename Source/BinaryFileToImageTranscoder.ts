...
export class BinaryFileToImageTranscoder
{
	static _instance: BinaryFileToImageTranscoder;
	static Instance(): BinaryFileToImageTranscoder
	{
	...
	bytesFromStringHexadecimal(bytesAsStringHexadecimal: string): number[]
	{
		var bytes = [];
	...
	bytesToCanvas(bytesAsStringHexadecimal: string): any
	{
	...
	bytesToImgElement(bytesAsStringHexadecimal: string, callback: any): any
	{
	...
	saveImgElementToFileWithName(imgElement: any, fileName: string): void
	{
	...
	imgElementToBytes(imgElement: any): number[]
	{
	...
	binaryStringToHexadecimal(binaryString: string): string
	{
	...
	dataUrlToImgElement(imageAsDataUrl: string, callback: any): void
	{
		var imgElement = document.createElement("img");
	...
	saveBytesFromHexadecimalToFileWithName(bytesAsStringHexadecimal: string, fileName: string): void
	{
		var bytes = this.bytesFromStringHexadecimal(bytesAsStringHexadecimal);
